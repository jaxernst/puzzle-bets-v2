...
library PlaybackWindow {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "v1", name: "PlaybackWindow", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627631000000000000000000000000506c61796261636b57696e646f770000);
