...
library GamePlayerStartTime {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "v1", name: "GamePlayerStartT", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462763100000000000000000000000047616d65506c61796572537461727454);
