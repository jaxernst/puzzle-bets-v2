...
library Player1 {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "v1", name: "Player1", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627631000000000000000000000000506c6179657231000000000000000000);
