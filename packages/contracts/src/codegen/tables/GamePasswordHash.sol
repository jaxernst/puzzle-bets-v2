...
library GamePasswordHash {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "v1", name: "GamePasswordHash", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462763100000000000000000000000047616d6550617373776f726448617368);
